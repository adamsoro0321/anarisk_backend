...
sql_ifu="""select  DCIS.LIBELLE structures,numeroifu NUM_IFU,IFU3.CONTRIBUABLES.LATITUDE, IFU3.CONTRIBUABLES.LONGITUDE, 
IFU3.NAEMAACTIVITES.LIBELLE ACTIVITES_IFU
